...
use ThankSong\LingXing\Dto\AccessTokenDto;
use ThankSong\LingXing\Exception\GenerateAccessTokenException;
use ThankSong\LingXing\Exception\InvalidAccessTokenException;
use ThankSong\LingXing\Exception\RequiredParamsEmptyException;
...
class OpenAPIRequestService
{
     ...
     *
     * @throws \ThankSong\LingXing\Exception\RequiredParamsEmptyException
     */
     ...
     *
     * @return array
     * @throws \ThankSong\LingXing\Exception\InvalidAccessTokenException
     * @throws \ThankSong\LingXing\Exception\InvalidResponseException
     ...
     *
     * @return \ThankSong\LingXing\Dto\AccessTokenDto
     * @throws \ThankSong\LingXing\Exception\InvalidResponseException
     * @throws \ThankSong\LingXing\Exception\RequestException
     */
     ...
     * @param $expireAt
     *
     * @throws \ThankSong\LingXing\Exception\GenerateAccessTokenException
     */
